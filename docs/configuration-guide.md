...
> Note: You can use confd without a configuration file. See [Command Line Flags](https://github.com/mikarinneoracle/confd/blob/master/docs/command-line-flags.md).
